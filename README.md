...
- **Digital PolieBotics - the demonstrated, maturing layer.** Its most mature piece is the **digital Truth Beam**: a
  ...
  headline metric is **recomputable from the released public per-frame scores** via the verify bundle; regenerating those scores from raw frames additionally needs the published weights), even when
